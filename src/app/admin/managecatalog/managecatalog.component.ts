...
export class ManagecatalogComponent implements OnInit {
  @ViewChild('callCreateServicesDailog')
  callCreateServicesDailog!: TemplateRef<any>;
  @ViewChild('callDeleteServicesDailog')
  callDeleteServicesDailog!: TemplateRef<any>;
  @ViewChild('callUpdateServicesDailog')
  callUpdateServicesDailog!: TemplateRef<any>;
  ...
  updateServices() {
    this.Admin.UpdateService(this.updateFormServices.value).subscribe(
      (resp) => {
  ...
  deleteServices(id: number) {
    ...
    dialogVal.afterClosed().subscribe((res) => {
      if (res != undefined) {
        if (res == 'yes') this.Admin.DeleteService(id);
        else res == 'no';
