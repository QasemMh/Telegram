...
export class PostComponent implements OnInit {
  ...
  constructor(public dialog: MatDialog,private router:Router , public home:HomeService ,private http:HttpClient ,private spinner :NgxSpinnerService ,private toster:ToastrService ,public admin:AdminService) { }
  ...
  GetAllPost(){
     ...
     this.http.get('https://localhost:44301/api/Post/AllPost').subscribe((res)=>{
      // this.spinner.show();
      this.AllPost=res;
      // this.spinner.hide();
  ...
  DeletePost(id:number){
    console.log("id" , id)
    this.http.delete('https://localhost:44301/api/Post/DeletePost/delete/' +id)
...
GetAllComments(){
  this.http.get('https://localhost:44301/api/Comments/GetAllCommentPost').subscribe((res)=>{
  ...
  AddComment(obj:any){
   ...
   let uid : number =  +User.userid;
    ...
    console.log(obj);
    console.log(addCom);
    this.http.post('https://localhost:44301/api/Comments/InsertComment' ,addCom).subscribe((resp:any)=>{
      // console.log(resp);
      // this.spinner.hide();
  ...
  GetCommentByPostID(Postid:number){
    this.http.get('https://localhost:44301/api/Comments/GetPostComments/'+ Postid).subscribe((resp:any)=>{
  ...
  CheckLike(postid :number , userid :number){
    this.http.get('https://localhost:44301/api/Comments/GetPostComments/'+ userid +"/" + postid).subscribe((resp:any)=>{
      this.isLike=resp;
    // this.spinner.hide();
     this.toster.success('Successfully :)')
  ...
  DeleteLike(obj){
    ...
    let uid : number =  +User.userid;
     ...
     this.http.delete('https://localhost:44301/api/Reaction/DeleteReaction/'+DeleteLike.userId +'/'+DeleteLike.postId)
  ...
  createLike(obj){
    ...
    this.http.post('https://localhost:44301/api/Reaction/InsertReaction',addLike).subscribe((resp:any)=>{
      console.log(resp);
      // this.spinner.hide();
    //this.toster.success(' send comment Successfully :)')
    this.GetAllReaction()
